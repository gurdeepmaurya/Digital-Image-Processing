...
enum e_bmp_api_histogram_suboperation{
    BMP_SUBOP_HISTOGRAM_DUMP_TRUE=0,
    BMP_SUBOP_HISTOGRAM_DUMP_FUZZY,
    BMP_SUBOP_HISTOGRAM_MAX
};
char *bmp_api_histogram_suboperation_str[BMP_SUBOP_HISTOGRAM_MAX]=
{
    "dump-true",
    "dump-fuzzy"
};
...
**/ 
#define BMP_SUBOP_MAX BMP_SUBOP_HISTOGRAM_MAX
...
int histogram_fuzzy_weights[HISTOGRAM_FUZZY_WINDOW]=
{
    2,
    3,
    4,
